module.exports = {
  ...
  products:{
    ...
    build:'building',
    test:'test network',
    product1:'NULS 2.0 Alpa version has been released',
    product2:'Chain Factory',
    product3:'Using Chain Factory, enterprises and individuals are not required to have a deep level of understanding of blockchain technology or cryptography in order to build their own blockchains',
    product4:'Module Repository',
    product5:'NULS module repository manages the base and business modules through simple operations such as validating, adding, deleting, and updating',
    product6:'NULS Wallets are developed by the NULS core team and Code Craft Council. We also provide third-party wallets. When using a third-party wallet you are responsible for the safety of your private key',
    product7:'Explorer',
    product8:'NULS explorers are developed by core team',
    ...
    product14:'NULS Space is a district centralized space',
    product15:'Vote',
    product16:'Introduction to Competitive DAPP',
    product17:'Wallet',
  },
